...
namespace WebAppBase.Api.Data.Migrations
{
    ...
    [Migration("20260914065609_LocationPointsOfInterest")]
    partial class LocationPointsOfInterest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebAppBase.Api.Domain.Entities.ConsentRecord", b =>
                {
                    ...
                    b.Property<string>("OtpPendingId")
                        .HasMaxLength(128)
            ...
            modelBuilder.Entity("WebAppBase.Api.Domain.Entities.LocationDetail", b =>
                {
                    ...
                    b.HasIndex("ArAnchorId");

                    b.HasIndex("NfcTagId");

                    b.HasIndex("TourStopId");
